...
import CircularPageLoader from 'src/features/components/page-loader/CircularPageLoader';
import { addSeller } from 'src/features/modules/user/reducers/seller.reducer';
import { addBuyer } from 'src/features/modules/user/reducers/user.reducer';
import { useCreateSellerMutation } from 'src/features/modules/user/services/seller.service';
import { IResponse } from 'src/features/shared/interfaces/shared.interface';
import { useAppSelector, IReduxState, useAppDispatch, showErrorToast, deleteFromLocalStorage } from 'src/features/store';
import { useSellerSchema } from '../../hooks/useSellerSchema';
import { IPersonalInfoData, IExperience, IEducation, ILanguage, ICertificate, ISellerDocument } from '../../interfaces/sellers.interface';
