...
import { checkImage, countriesList, readAsBase64, saveToSessionStorage, useAppDispatch } from 'src/features/store';
...
const RegisterModal: FC<IModalBgProps> = ({ onClose, onToggle }): ReactElement => {
  ...
  const [country, setCountry] = useState<string>('Selecionar pais');
      ...
      <div className="relative top-[10%] mx-auto w-11/12 max-w-md rounded bg-white md:w-2/3">
        <div className="relative px-5 py-5">
          <div className="flex justify-between text-2xl font-bold text-gray-600">
            ...
            <h1 className="flex w-full justify-center">Registrate</h1>
            <Button
              className="cursor-pointer rounded text-gray-400 hover:text-gray-600"
              role="button"
              onClick={onClose}
